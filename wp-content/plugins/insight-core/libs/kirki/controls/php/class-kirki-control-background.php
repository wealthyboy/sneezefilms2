	...
	protected function content_template() {
        ...
        <div class="background-color">
            ...
            <input type="text" data-default-color="{{ data.default['background-color'] }}" data-alpha="true"
                   value="{{ data.value['background-color'] }}" class="kirki-color-control"/>
        </div>
        ...
        <div class="background-image">
            ...
            <div class="attachment-media-view background-image-upload">
                ...
                <div class="actions">
                    ...
                    <button type="button"
                            class="button background-image-upload-button"><?php esc_attr_e( 'Select File', 'kirki' ); ?></button>
                </div>
            </div>
        </div>
        ...
        <div class="background-repeat">
            ...
            <select {{{ data.inputAttrs }}}>
                ...
                #>><?php esc_attr_e( 'No Repeat', 'kirki' ); ?></option>
                <option value="repeat-all"
                <# if ( 'repeat-all' === data.value['background-repeat'] ) { #> selected <# }
                #>><?php esc_attr_e( 'Repeat All', 'kirki' ); ?></option>
                <option value="repeat-x"
                <# if ( 'repeat-x' === data.value['background-repeat'] ) { #> selected <# }
                #>><?php esc_attr_e( 'Repeat Horizontally', 'kirki' ); ?></option>
                <option value="repeat-y"
                <# if ( 'repeat-y' === data.value['background-repeat'] ) { #> selected <# }
                #>><?php esc_attr_e( 'Repeat Vertically', 'kirki' ); ?></option>
            </select>
        </div>
        ...
        <div class="background-size">
            ...
            <div class="buttonset">
                <input {{{ data.inputAttrs }}} class="switch-input screen-reader-text" type="radio" value="cover"
                       name="_customize-bg-{{{ data.id }}}-size" id="{{ data.id }}cover" <# if ( 'cover' ===
        ...
        <div class="background-attachment">
            ...
            <div class="buttonset">
                <input {{{ data.inputAttrs }}} class="switch-input screen-reader-text" type="radio" value="scroll"
                       name="_customize-bg-{{{ data.id }}}-attachment" id="{{ data.id }}scroll" <# if ( 'scroll' ===
                data.value['background-attachment'] ) { #> checked="checked" <# } #>>
                <label class="switch-label switch-label-<# if ( 'scroll' === data.value['background-attachment'] ) { #>on <# } else { #>off<# } #>"
                       for="{{ data.id }}scroll"><?php esc_attr_e( 'Scroll', 'kirki' ); ?></label>
                </input>
                <input {{{ data.inputAttrs }}} class="switch-input screen-reader-text" type="radio" value="fixed"
                       name="_customize-bg-{{{ data.id }}}-attachment" id="{{ data.id }}fixed" <# if ( 'fixed' ===
                data.value['background-attachment'] ) { #> checked="checked" <# } #>>
                <label class="switch-label switch-label-<# if ( 'fixed' === data.value['background-attachment'] ) { #>on <# } else { #>off<# } #>"
                       for="{{ data.id }}fixed"><?php esc_attr_e( 'Fixed', 'kirki' ); ?></label>
                </input>
            </div>
        </div>
