...
class Kirki_Control_Color extends Kirki_Control_Base {
	...
	protected function content_template() {
        ...
        <input type="text" data-type="{{{ data.mode }}}" {{{ data.inputAttrs }}} data-palette="{{ data.palette }}"
               data-default-color="{{ data.default }}" data-alpha="{{ data.choices['alpha'] }}" value="{{ data.value }}"
               class="kirki-color-control" {{{ data.link }}}/>
		<?php
	}
}
