<div class="wrap insight-core-wrap" id="insight-import-page">
	...
	if ( function_exists( 'phpversion' ) ) {
		...
		if ( version_compare( $php_version, '5.6', '<' ) ) {
            ...
            <div class="notice notice-error" style="display: block !important;">
                <p>
					<?php esc_html_e( 'Insight Core requires PHP version 5.6 or greater. Please contact your hosting provider to upgrade PHP version.', 'insight-core' ) ?>
                </p>
            </div>
			<?php
		}
	...
	if ( ! function_exists( 'fsockopen' ) && ! function_exists( 'curl_init' ) ) {
        ...
        <div class="notice notice-error" style="display: block !important;">
            <p>
				<?php esc_html_e( 'Your server does not have fsockopen or cURL enabled. Please contact your hosting provider to enable it.', 'insight-core' ) ?>
            </p>
        </div>
		<?php
	}
	...
	if ( ! class_exists( 'DOMDocument' ) ) {
        ...
        <div class="notice notice-error" style="display: block !important;">
            <p>
				<?php printf( __( 'Your server does not have <a href="%s">the DOM extension</a> class enabled. Please contact your hosting provider to enable it.', 'insight-core' ), 'http://php.net/manual/en/intro.dom.php' ) ?>
            </p>
        </div>
		<?php
	}
	...
	if ( ! class_exists( 'XMLReader' ) ) {
        ...
        <div class="notice notice-error" style="display: block !important;">
            <p>
				<?php printf( __( 'Your server does not have <a href="%s">the XMLReader extension</a> class enabled. Please contact your hosting provider to enable it.', 'insight-core' ), 'http://php.net/manual/en/intro.xmlreader.php' ) ?>
            </p>
        </div>
		<?php
	}
