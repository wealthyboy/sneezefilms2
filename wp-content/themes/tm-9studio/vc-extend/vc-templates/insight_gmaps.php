...
$el_class = $this->getExtraClass( $el_class ) . ' insight-gmaps';
$uid      = uniqid( 'insight-gmaps-' );
...
switch ( $map_style ) {
	...
	case 'style11':
		...
		break;
	case '9studio':
		$map_style_snippet = '[{"featureType":"poi","elementType":"all","stylers":[{"saturation":"-85"}]},{"featureType":"water","elementType":"all","stylers":[{"saturation":"-85"},{"lightness":"0"},{"gamma":"1"},{"weight":"0.56"},{"hue":"#00fbff"}]}]';
		break;
	default:
		$map_style_snippet = '';
}
...
<script type="text/javascript">
	jQuery( document ).ready( function( $ ) {
		var gmMapDiv = $( "#<?php echo esc_attr( $uid ); ?>" );
		(
			function( $ ) {
				if ( gmMapDiv.length ) {
